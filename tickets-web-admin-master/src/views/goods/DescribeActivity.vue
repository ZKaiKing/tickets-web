  ...
  <div>
    <Card>
      ...
      <Row>
        <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
          <Form-item label="活动说明" prop="name">
            <Input type="text" v-model="searchForm.name" clearable placeholder="请输入活动说明名称" style="width: 200px" />
          </Form-item>
    ...
    <Modal :title="modalTitle" v-model="modalVisible" :mask-closable="false" :width="500" :style="{top:'30px'}">
      <Form ref="dataOperForm" :model="dataOperForm" :label-width="100" :rules="dataOperFormValidate">
        <FormItem label="活动说明名：" prop="name">
        ...
        <FormItem label="活动说明内容" prop="content">
          <Input v-model="dataOperForm.content" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入活动说明内容"></Input>
        </FormItem>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '活动说明名称', key: 'name', align: 'center', minWidth: 200, sortable: true },
          ...
          { title: '活动说明内容', key: 'content', align: 'center', minWidth: 200, sortable: true },
        ...
        dataOperFormValidate: {
          name: [
            { required: true, message: "活动说明名称不能为空", trigger: "change" }
          ],
          enabled: [
          ...
          content: [
            { required: true, message: '活动说明内容不能为空', trigger: "change" }
          ]
        },
      }
    },
