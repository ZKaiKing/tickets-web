    ...
    <Card>
      ...
      <Row>
        <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
          <Form-item label="敏感词" prop="name">
            <Input type="text" v-model="searchForm.name" clearable placeholder="请输入敏感词" style="width: 200px" />
          </Form-item>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '敏感词', key: 'name', align: 'center', minWidth: 200, sortable: true },
