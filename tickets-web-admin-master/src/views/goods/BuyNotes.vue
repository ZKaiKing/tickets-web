  ...
  <div>
    <Card>
      ...
      <Row>
        <Form ref="searchForm" :model="searchForm" inline :label-width="70" class="search-form">
          <Form-item label="购买须知" prop="name">
            <Input type="text" v-model="searchForm.name" clearable placeholder="请输入购买须知名称" style="width: 200px" />
          </Form-item>
    ...
    <Modal :title="modalTitle" v-model="modalVisible" :mask-closable="false" :width="500" :style="{top:'30px'}">
      <Form ref="dataOperForm" :model="dataOperForm" :label-width="100" :rules="dataOperFormValidate">
        <FormItem label="购买须知名：" prop="name">
        ...
        <FormItem label="购买须知内容" prop="content">
          <Input v-model="dataOperForm.content" type="textarea" :autosize="{minRows: 2,maxRows: 5}" placeholder="请输入购买须知内容"></Input>
        </FormItem>
    ...
    data() {
      return {
        ...
        columns: [
          ...
          { title: '购买须知名称', key: 'name', align: 'center', minWidth: 200, sortable: true },
          ...
          { title: '购买须知内容', key: 'content', align: 'center', minWidth: 200, sortable: true },
        ...
        dataOperFormValidate: {
          name: [
            { required: true, message: "购买须知名称不能为空", trigger: "change" }
          ],
          enabled: [
          ...
          content: [
            { required: true, message: '购买须知内容不能为空', trigger: "change" }
          ]
        },
      }
    },
